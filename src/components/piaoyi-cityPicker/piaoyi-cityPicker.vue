    ...
    confirm() {
      if (this.column == 3) {
        this.$emit('confirm', {
          ...
          provinceCode: addressList[this.provinceIndex].code,
          // 市
          cityName: addressList[this.provinceIndex].children[this.cityIndex].name,
          cityCode: addressList[this.provinceIndex].children[this.cityIndex].code,
          // 区
          areaName:
            addressList[this.provinceIndex].children[this.cityIndex].children[this.areaIndex].name,
          areaCode:
            addressList[this.provinceIndex].children[this.cityIndex].children[this.areaIndex].code,
        })
      } else if (this.column == 2) {
        this.$emit('confirm', {
          code:
